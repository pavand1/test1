    ...
    return (
        <>
            <section className="mid-section">
                <h1 className="main-heading blue-text-heading">
                    Level I - Fear: The Book
                </h1>
                <h4>
                    Rent The Book To Discover, Evolve, and Ignite Your
                    Self-Transcedence!{" "}
                </h4>
                <div className="level-content">
                    <p>
                        Embark on a transformative journey with this captivating
                        audio ebook by the enigmatic Salssky. Blending action,
                        thriller, and romance, "Salssky: The Choosen One" offers
                        profound insights into self-transcedence.
                    </p>
                </div>
                {/*level-content*/}
                <div className="level-content">
                    ...
                    <ul className="blue-checkmark">
                        <li>
                            <strong>Affordable Access:</strong>Just $0.13 per
                            day for a transformative experience.{" "}
                        </li>
                        <li>
                            <strong>Captivating Story:</strong>Follow Salssky's
                            thrilling quest for self-transcedence.{" "}
                        </li>
                        <li>
                            <strong>Engaging Experience:</strong>Dive into a
                            narrative filled with mystery and enlightment.{" "}
                        </li>
                        <li>
                            <strong>Enhanced Connection:</strong>Enjoy the
                            poetic brilliance of "whispers of the soul" and
                            "Epilogues" to ignite your inner transformation.{" "}
                        </li>
                    </ul>
                </div>
                {/*level-content*/}
                    ...
                    <div className="offer-boxes">
                        <div className="row">
                            ...
                            <div className="col-sm-4 col-6">
                                <div className="monthly-box blue-box">
                                    <h4 className="blue-text-heading">
                                        Monthly
                                    </h4>
                                    <h3>$4.00</h3>
